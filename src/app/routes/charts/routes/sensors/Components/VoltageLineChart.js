    ...
    render() {
        ...
        <ResponsiveContainer width="100%" height={200}>
            <LineChart data={this.state.data}
                ...
                <YAxis domain={[200, 270]} />
                <CartesianGrid strokeDasharray="3 3" />
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="RY_VOLT" stroke="#FF0000"  />
                <Line type="monotone" dataKey="YB_VOLT" stroke="#B1B200"  />
                <Line type="monotone" dataKey="BR_VOLT" stroke="#3367d6"  />
